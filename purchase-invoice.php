...
<body class="hold-transition sidebar-mini layout-fixed">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Purchase Invoice Create</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                        ...
                        <form method="POST" action="">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-3">
                                        <div class="form-group">
                                            <label>Vendor's Name/Company Name</label>
    ...
    $('#addUpdateInvoiceBtn').on('click', function() {
        ...
        let sendApiDataObj = {
            '<?php echo systemProject ?>': 'Masters',
            '<?php echo systemModuleFunction ?>': 'addUpdatePurchaseInvoiceDetails',
            'action': action,
            'invoiceId': invoiceId,
        ...
        APICallAjax(sendApiDataObj, function(response) {
            ...
            if (response.responseCode == RESULT_OK) {
                ...
                window.location = "purchase-invoice-list.php";
            } else {
